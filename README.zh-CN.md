...
| [evaluate-steam-games](.agents/skills/evaluate-steam-games/SKILL.md) | 基于 Steam 评测、近期论坛动态、当前产品状态、Steam 商店定价及折扣规律分析，以及抢先体验开发信号，生成游戏评估报告。[^early-access-signals] |
...
独立的价格、折扣和史低分析仅覆盖 Steam 商店。捆绑包信息仍为多店铺范围，是唯一的非 Steam 价格例外。
...
- 只有查询 Steam 商店价格、折扣、史低、折扣规律或捆绑包时才需要 [IsThereAnyDeal API key](https://isthereanydeal.com/apps/)。
