...
| 技能 | 用途 |
| --- | --- |
| [filter-steam-wishlist](.agents/skills/filter-steam-wishlist/SKILL.md) | 列出公开的用户愿望单，可按打折或史低状态筛选。 |
| [evaluate-steam-games](.agents/skills/evaluate-steam-games/SKILL.md) | 基于 Steam 评测、近期论坛动态、开发状态信号，生成游戏评估报告。 |

## 提示词示例

- “列出我的 Steam 愿望单上的所有游戏。”
- “列出我的 Steam 愿望单上正在打折的游戏。”
