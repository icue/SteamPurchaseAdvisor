...
| 技能 | 用途 |
| --- | --- |
| [filter-steam-wishlist](.agents/skills/filter-steam-wishlist/SKILL.md) | 列出公开的用户愿望单，可按 Steam 商店打折、Steam 商店史低、是否提供试玩版、抢先体验或正式发行状态筛选。 |
...
- “列出我的愿望单上已经正式发行的、达到史低的游戏。”
- “列出我的愿望单中正在打折的、提供了试玩版的抢先体验游戏。”
- “Steam 游戏 XXX 现在值得入手吗？”
- “为我愿望单上的所有打折游戏给出购买建议。”
- “查看我愿望单上的抢先体验游戏的 Steam 讨论区，哪些有要跑路的迹象？”
