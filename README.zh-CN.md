...
| 技能 | 用途 |
| --- | --- |
| [filter-steam-wishlist](.agents/skills/filter-steam-wishlist/SKILL.md) | 列出公开的用户愿望单，可按打折、史低、抢先体验或正式发行状态筛选。 |
| [evaluate-steam-games](.agents/skills/evaluate-steam-games/SKILL.md) | 基于 Steam 评测、近期论坛动态、当前产品状态及抢先体验开发信号，生成游戏评估报告。[^early-access-signals] |
...
- 只有查询价格、折扣或史低时才需要 [IsThereAnyDeal API key](https://isthereanydeal.com/apps/)。
...
| **itad_api_key** | ITAD API key 字符串，用于当前价格、折扣和史低查询。可在 [IsThereAnyDeal](https://isthereanydeal.com/apps/) 创建应用后获得。 |
| **pricing_country** | 大写两位 ISO 3166-1 国家代码，例如 **"US"** 或 **"CN"**，用于选择区域价格。 |
